...
In 2–3 sentences, what are you recommending and why does it matter now?
...
Competitor landscape—how are other vendors leveraging partners?
...
How does this program align with your company’s current OKRs and strategic pillars?
...
Pro Tip:
Include a “do nothing” scenario: What happens if you don’t invest?
...
Regional, national, global—where do you need footprint?
...
What are the “hard nos”? (e.g., direct competitors, poor NPS, no technical team, channel conflict)
...
Format:
Weighted scorecard (e.g., 0–5 per C, add notes/examples for each)
...
Pro Tip:
Use during both recruitment and annual QBRs—make it transparent with the partner.

4. Competitive Differentiation Template
Purpose:
Arm your team and partners with clear reasons to pick you—beyond buzzwords.
Fields & Prompts:
Competitive Matrix:


Feature comparison table: Your solution vs. top 3–5 alternatives.
...
For SI partners: what’s the attach rate and margin opportunity?
...
Quick table: Strengths, Weaknesses, Opportunities, Threats—specific to the partner motion.


Pro Tip:
Refresh this quarterly or as competitive landscape shifts—don’t let it get stale.

5. Partner Strategy Plan Template
Purpose:
Guide your partner team’s annual/quarterly planning with a structured, repeatable document.
Sections & Prompts:
Vision & Mission:
...
SI, ISV, channel, OEM, etc. — target # and profile in each.
...
Purpose:
Document and communicate your partner program structure—internally and externally.
Sections & Prompts:
Tier Definitions:
...
Pro Tip:
Create a public-facing and internal version—keep rules simple for partners, detailed for internal ops.
...
Pro Tip:
Tie alignment to incentives; make sure field teams know what’s in it for them if they follow the playbook.
...
“[Your Company] + [Their Company]: Unlocking [Market/Outcome] Together”


“Exploring Strategic Alignment with [Their Company]”
...
“We believe a partnership between [your company] and [their company] could unlock [shared value prop or specific outcome] for both our customer bases.”


Clear call to action: “Would you be open to a 20-min intro call next week?”


Sample:
Hi [Name],
I’m reaching out because [Their Company] is known for [notable achievement], and we’re looking for select partners to expand our joint impact in [vertical/region].
...
2nd follow-up: “If now isn’t the right time, is there someone else on your team I should speak with?”
...
Step 2: LinkedIn connection request (personalized: “Saw you’re leading alliances at X, would love to connect”)
...
Step 5: Break-up email (“I don’t want to spam you; let me know if this isn’t a fit for now”)
...
“Who are your top customers? How do you generate pipeline?”


“What is your target market and does it align with ours?”


Delivery Capabilities:


“Do you have technical certifications? Reference implementations?”


Past Vendor Partnerships:


“Which vendors have you partnered with before, and what worked/didn’t?”


Go-to-Market Model:


“How do you prefer to engage—referral, resell, co-sell?”


Resource Commitment:


“What resources can you dedicate (headcount, marketing, exec sponsor)?”
...
“How to Partner” (timeline, onboarding, support)
...
How to Start: Step-by-step (sign NDA → intro call → onboarding checklist).
...
Partner’s Customer Segments: Mapped fields to your ICP.
...
🔧 PARTNER ENABLEMENT TEMPLATES (Expert-Level, 2–3 Layers Deep)
...
Day 0: “Signed, welcome email, access to portal”


Week 1: “Attend onboarding session; review program overview”


Month 1: “Complete sales/technical certification; access sandbox/demo environment”


Month 2: “Register first opportunity; joint pipeline review”


Q1/Q2: “Attend partner bootcamp, participate in joint event”


Learning Paths:


Sales: “Core pitch, objection handling, battlecard review”


Technical: “Hands-on lab, implementation walkthrough, integration best practices”


Milestones:


“Certified sales lead identified”
...
“Quarterly product updates completed”


Ongoing Enablement:


“Quarterly webinars, roadmap previews, advanced workshops”
...
Core Slides & Prompts:
Welcome: “Meet your partner team, how we support you.”


Product Overview: “What is [product]? Key use cases. Demo video.”


Customer Stories: “Logo slide, 2–3 rapid-fire win stories.”


Competitive Landscape: “How we win vs. [Competitor A/B/C]. Sample talk track.”


Sales Process: “Deal registration steps. How to co-sell. Support escalation.”


Demo Guidance: “Which flows to show; where to pause for customer questions.”


Partner Resources: “Portal links, support contacts, Slack/Teams invite.”
...
Pass knowledge check (sample: 10–question quiz)
...
Renewal/Maintenance:
“Certifications expire annually or on major release—renew by [date]”


“At least 2 certified resources per Gold partner tier”
...
Field Prompts:
Elevator Pitch: “In one line: Why [Product]?”


Who to Target: “Best fit: [industry, use case, company size]”
...
“We use [competitor].”
 ...
 Response: “Box is the only FedRAMP High option with [feature]. Here’s how our F100 client switched.”


“Is Box secure?”

 Response: “Box is used by [number] of the Fortune 500; here’s our security approach.”


Competitive Matrix: “3–column table: Us vs. Competitor A vs. Competitor B”


Proof Points: “Recent win, stat, or third-party validation”
...
Purpose:
Ensure demos are consistent, value-driven, and “idiot-proof” for new partners.
Script Prompts:
Setup: “Log into sandbox. Load pre-configured demo data.”


Demo Flow:


“Start at Dashboard. Show file upload.”


“Demonstrate workflow automation—trigger an approval.”


“Switch to mobile; show annotation or signature.”


Callouts: “Highlight AI-driven insights at step 2; emphasize compliance at step 3.”


Pitfalls: “If app disconnects, refresh and relogin; have backup video ready.”


Closing: “Ask prospect: ‘What would this change for your team?’ Offer next step: trial access or solution workshop.”
...
“[Competitor X] is strongest in [vertical], but typically lacks [feature].”


Winning Points:


“Box integrates natively with [platform]; [Competitor] is closed.”


“Our NPS is [score], market average is [score].”


Common Scenarios:


“Customer says, ‘But [Competitor] is cheaper.’”

 Response: “Let’s compare total cost of ownership and risk profile—here’s an example from [customer].”


Landmines to Plant:


“Ask if their compliance certs are up to date; in [industry], that’s a dealbreaker.”


Proof/Validation:


“Show analyst report, G2 badge, or logo slide.”
...
Guide Sections:
When to Co-Sell: “If partner sourced or >$50K opportunity, use co-sell.”


Roles & RACI:


“Box AE: Owns forecast, Partner AE: sources leads, SE: runs demo.”
...
“No deal poaching; joint calls required for stage 2+.”


“Partner must log activity for deal credit.”


Escalation/Conflict:


“If disagreement: partner manager mediates; if no resolution, escalate to alliances lead.”
...
Example: “Enterprise sales teams waste up to 30% of their time searching for critical documents.”
...
Example: “Box integrated with Salesforce delivers instant access to critical sales content directly within CRM.”
...
Example: “Only Box+Salesforce integration offers FedRAMP-compliant storage seamlessly embedded within CRM.”
...
Example: “Large enterprise financial institutions regulated under SEC, FINRA, or FedRAMP High requirements.”
...
Example: “Reduced sales cycle time by 15% at Major Bank X.”
...
Example: “Schedule a personalized demo or access our sandbox environment today.”
...
Example: “Generate 200 marketing-qualified leads from enterprise tech segment.”
...
Example: “Secure collaboration simplified.”
...
Example: “Joint webinar series, industry whitepaper, LinkedIn ads.”
...
Example: “Webinar on June 10, follow-up nurture June 15–July 15.”
...
Example: “Each partner allocates $10k to digital ads, Box provides content creation.”
...
Example: “100 webinar attendees, 20 meetings booked, $500k pipeline influenced.”
...
Example: “Finalize partner enablement webinar by May 1, collateral approved by May 5.”
...
Example: “Press release published 9 am PST, sales team announcement by noon.”
...
Example: “Send customer feedback survey, conduct partner debrief session within two weeks.”
...
Example: “Drive $1M pipeline in healthcare vertical.”
...
Example: “C-level executives at mid-sized hospitals and healthcare networks.”
...
Example: “Reduce patient data risks with Box Secure Health.”
...
Example: “Three promotional emails, landing page, follow-up case study.”
...
Example: “First email sent May 1, webinar live May 15, follow-ups through June 1.”
...
Example: “200 registrations, 20 meetings set, $100K ARR closed.”
...
Example: “June 20, 2025, San Francisco Box HQ, 2–5 pm.”
...
Example: “Senior IT leaders from regulated industries.”
...
Example: “CTO keynote (30 mins), security demo (20 mins), customer panel (40 mins).”
...
Example: “Box responsible for venue, Salesforce for invites.”
...
Example: “Total budget $10K: Venue ($5K Box), Catering ($5K Partner).”
...
Example: “Post-event survey, meetings booked, pipeline attribution within 30 days.”
...
Example: “This playbook helps field marketers execute proven regional programs efficiently.”
...
Example: “Monthly roundtable dinners, quarterly webinars.”
...
Example: “Submit via internal request form two weeks in advance.”
...
Example: “Minimum expected ROI of 5x spend.”
...
Example: “Report leads generated weekly, pipeline monthly.”
...
Example: “Personalized invites significantly increase attendance rates.”
...
Example: “Solve compliance challenges—join our exclusive webinar.”
...
Example: “Join Box and Salesforce to see how secure collaboration accelerates deals—register today.”
...
Example: “We’re excited to see you tomorrow—here’s your webinar link again!”
...
Example: “Include .ics file in every confirmation email.”
...
Performance Metrics (1–2 slides)
...
Implementation Guidance:
Share deck template with partners 1–2 weeks prior to QBR.
...
Example: “The Partner Manager will strategically develop and manage key SI and technology partnerships, directly influencing revenue growth.”
...
Years of relevant experience (e.g., “5+ years in partnership or channel management”).
...
Clearly defined KPIs (e.g., “Deliver $2M ARR through partner-sourced deals annually”).


Qualitative success measures (e.g., “Develop and maintain positive partner NPS score”).
...
“Describe a successful partner program you built from scratch. How did you measure success?”


“What criteria do you use to prioritize and select partners?”


Execution & Results:


“Provide an example of a challenging partnership that you turned around. What specific actions did you take?”


“How have you historically tracked and optimized pipeline with partners?”


Cross-functional Collaboration:


“Give an example of aligning multiple internal teams behind a partnership initiative.”


“How do you handle misalignment between sales, marketing, and partnerships?”


Conflict Management & Negotiation:


“Describe a time when you navigated a difficult negotiation with a partner. How did you ensure a positive outcome?”


“Provide an example of a conflict with a partner that you resolved successfully.”


Communication & Influence:


“Tell me about how you maintain clear, effective communication with partner executives.”


“How do you manage partner expectations to ensure alignment and satisfaction?”
...
Develop roadmap for next quarter’s activity.
