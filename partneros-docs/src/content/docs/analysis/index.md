...
description: Measure and improve partner program health with data-driven insights
---
...
<p>Quarterly assessment of partner engagement, performance, and growth potential.</p>
</a>
...
| Situation | Template |
|-----------|----------|
| Quarterly partner review | [Health Scorecard](01-health-scorecard/) |
| Identify at-risk partners | [Health Scorecard](01-health-scorecard/) |
| Plan engagement activities | [Health Scorecard](01-health-scorecard/) |

## Health Scorecard Dimensions

```mermaid
graph TD
    A[Partner Health] --> B[Revenue]
    A --> C[Engagement]
    A --> D[Growth]
    A --> E[Sentiment]
```
