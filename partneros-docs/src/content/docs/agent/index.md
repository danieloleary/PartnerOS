...
- [Setup Guide](setup/) - Detailed installation and configuration
- [Playbooks](playbooks/) - Deep dive into each playbook
- [Configuration](configuration/) - Customize the agent
